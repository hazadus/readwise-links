...
<template>
  <div class="p-2 my-2 border rounded-lg">
    <!-- Заголовок и автор -->
    ...
    <p
      v-if="note.notes"
      class="p-2 mx-2 mb-1 bg-green-100 text-gray-700 text-sm rounded-lg"
    >
      📝 {{ note.notes }}
    </p>
    <!-- Summary -->
    <div
      v-if="note.summary"
      class="p-2 mx-2 text-gray-500 text-sm rounded-lg bg-gray-100"
    >
      {{ note.summary }}
    </div>
